      ...
      <Row className={styles.main}>
        ...
        <Col>
          ...
          <p className={styles.description}>
            For the <b>purpose of attendance</b>, you need to either enter the
            code or scan the qr code on your seat to grab an attendance.
          </p>
          {attendance ? (
            <p className={styles.description}>
              <b style={{ color: "#1d37c2" }}>
                Your attendance has already been taken!{" "}
              </b>
            </p>
          ) : (
            <></>
                ...
                <>
                  {!verifiedScan ? (
                    ...
                    <>
                      <Col sm={12} lg={true} style={{ marginTop: "3rem" }}>
                        <div>
                          The seat code scanned is - <b>{data}</b>
                        </div>
                      </Col>
                      <Col sm={12} lg={true} style={{ marginTop: "3rem" }}>
                        <div style={{ fontWeight: "600" }}>
                            ...
                            <InputGroup style={{ marginBottom: "3rem" }}>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  if (otp === code1) {
                                    toast.notify(
                                      "Attendance will be taken manually for the time being",
                                      {
                                        duration: 5,
                                        type: "success",
                                      }
