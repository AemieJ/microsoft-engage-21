        ...
        <Col sm={12} lg={true}>
          <div>
            <div className={styles.title}>
              {"Let's"} get started with the timetable 🚀
            </div>
            <div className={styles.description}>
              Here, you will mention the day and date of the classes you have
              created to be <b>included in the timetable for students.</b>
            </div>
          </div>
          ...
          {disabled ? (
            <>
              <div style={{ fontWeight: "600", color: "#a10104" }}>
                Timetables can only be created each saturday. Please visit on
                saturday to create the timetable.
              </div>
            </>
          ) : (
            <></>
          ...
          <Form autoComplete="new-password" className={styles.form}>
            ...
            <Form.Group style={{ display: "flex", marginTop: "2rem" }}>
              ...
              <Form.Label className={styles.check_alert}>
                <b>
                  This setting will be for the entire semeseter and the
