  ...
  const insertData = async (e) => {
    ...
    if (name.length === 0 || code.length === 0 || link.length === 0) {
      ...
      if (err) {
        ...
        toast.notify(
          "Class has been created successfully. Next setup the timetable",
          {
            duration: 5,
            type: "success",
          }
        ...
        <Col sm={12} lg={true}>
          <div>
            ...
            <div className={styles.description}>
              As a faculty, you can create a new subject class and
              <b>share the code with your students to join this class.</b>
            </div>
          </div>
