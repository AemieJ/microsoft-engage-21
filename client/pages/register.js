    ...
    if (
      ...
      if (valid && password === rePass) {
        ...
        if (err) {
          ...
          toast.notify(
            "Registration Successful. Please login with the credentials",
            {
              duration: 5,
              type: "success",
            }
        ...
        <Col sm={12} lg={true}>
          <div>
            ...
            <div className={styles.description}>
              Just easily fill up the form in a few seconds, and you will be
              able to you manage your preferences and attendences.
            </div>
          </div>
          <Form autoComplete="new-password" className={styles.form}>
            ...
            <div className={styles.radio_sec}>
              <div>
                ...
                <div
                  key={`inline-radio-1`}
                  className={`mb-3 ${styles.form_control}`}
                >
                  <Form.Check
                    inline
                    required
            ...
            <div className={styles.password_sec}>
              ...
              <Form.Group
                className={`mb-3 ${styles.password}`}
